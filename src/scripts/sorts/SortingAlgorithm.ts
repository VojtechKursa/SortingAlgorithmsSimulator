...
class TemporaryIndexedNumber {
	/**
	 * Creates a new TemporaryIndexedNumber.
	 *
	 * @see IndexedNumber for parameter descriptions as they're identical.
	 */
	public constructor(
...
class IndexingData {
	/**
	 * Creates a new instance of IndexingData.
	 *
...
export abstract class SortingAlgorithm {
	...
	/**
	 * Creates a new sorting algorithm instance.
	 *
